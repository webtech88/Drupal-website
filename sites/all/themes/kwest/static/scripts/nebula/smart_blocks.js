 ...
 *     }
 */
define('nebula/smart_blocks', ['settings', 'nebula/signal', 'nebula/viewport', 'jquery'], function(settings, Signal, viewport, jQuery) {
    'use strict';
    ...
    function updateTree(root) {
        ...
        for (selector in BLOCKS) {
            blocks = jQuery(root).find(selector).each(function(i, block) {
                updateBlock(block, BLOCKS[selector], selector);
            });
        }
    }
